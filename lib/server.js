...
const ProppsSvgRenderer = require('./renderer/propps-svg')
const ProppsSvgRendererStatic = require('./renderer/propps-svg-tag-static')
...
function getRendererFromType (type) {
  switch (type) {
    ...
    case 'propps-svg-tag-static':
      return ProppsSvgRendererStatic
    case 'txt':
    case 'utf8':
      return Utf8Renderer
